...
<form action="<?php echo site_url("/admin/user/insert"); ?>" method="post">
    <fieldset>
        ...
        <div class="form-group">
                ...
                <input class="form-control" placeholder="User name" type="text" id="username" name="username" value="<?php echo set_value('username'); ?>" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" placeholder="Valid Email" type="text" id="email_address" name="email_address" value="<?php echo set_value('email_address'); ?>" />
        </div>
